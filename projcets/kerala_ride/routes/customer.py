...
def estimate_fare():
    ...
    if category in goods_categories:
        target_categories = goods_categories
    else:
        target_categories = passenger_categories
    ...
    for cat in target_categories:
        ...
        try:
            ...
            print(f"FareConfig query error for {cat}: {db_err}")
        ...
        cat_final_fare = cat_forward_fare + cat_return_charge
